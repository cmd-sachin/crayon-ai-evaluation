...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__ = __turbopack_import__("[project]/node_modules/zustand/esm/index.mjs [app-ssr] (ecmascript) <exports>");
...
const useQuizStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$exports$3e$__["default"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["persist"])((set)=>({
        ...DEFAULT_STATE,
        setCurrentQuestionIndex: (index)=>set({
                currentQuestionIndex: index
            }),
        addQuizData: (questionNumber, data)=>set((state)=>({
                    quizData: {
                        ...state.quizData,
                        [questionNumber]: data
                    }
                })),
        addQuizHistory: (entry)=>set((state)=>({
                    quizHistory: [
                        ...state.quizHistory,
                        entry
                    ]
...
const __TURBOPACK__default__export__ = useQuizStore;
}}),
...
function QuizPage() {
    const { currentQuestionIndex, setCurrentQuestionIndex, addQuizData, addQuizHistory, quizHistory, resetQuiz } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$stores$2f$quizStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])();
    // Local state for current question, current answer, dynamic loading, and error.
    ...
    const [loadingDynamic, setLoadingDynamic] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [error, setError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    // Optionally, reset quiz on mount to clear stale persisted state.
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (currentQuestionIndex < staticQuestions.length) {
            // Use a static question.
            setCurrentQuestion(staticQuestions[currentQuestionIndex]);
        } else {
            // For dynamic questions (Questions 9–13), call the API.
            const fetchDynamic = async ()=>{
                setLoadingDynamic(true);
                try {
                    const dynamicQuestion = await fetchDynamicQuestion(quizHistory);
    ...
    // On clicking "Next," validate and store the answer immediately.
    const handleNext = async ()=>{
        ...
        // Store in both quizData (persistent) and quizHistory.
        addQuizHistory(entry);
        addQuizData(qNumber, entry);
        setAnswer(""); // reset input for the next question
        if (currentQuestionIndex + 1 < totalQuestions) {
            setCurrentQuestionIndex(currentQuestionIndex + 1);
        } else {
            // All questions answered – you can navigate to a results page.
            alert("Quiz completed!");
        }
    };
    // Render input based on the current question's type.
    const renderInput = ()=>{
        ...
        switch(currentQuestion.inputType){
            ...
            case "radio":
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: currentQuestion.options.map((opt, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                            style: {
                                marginRight: "12px"
                            },
                            children: [
...
// Helper function that calls the API endpoint to generate a dynamic question.
// It sends the current quizHistory as messages.
async function fetchDynamicQuestion(messages) {
    ...
    // The API should return an object with at least { section, question, inputType, ... }.
    return data;
}
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9bc602._.js.map