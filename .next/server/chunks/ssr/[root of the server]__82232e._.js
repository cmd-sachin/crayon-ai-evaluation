...
function QuizPage() {
    ...
    const { quizData, addQuizData, currentQuestionIndex, setCurrentQuestionIndex, timer, setTimer } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$stores$2f$quizStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuizStore"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (currentQuestionIndex >= questions.length && currentQuestionIndex < TOTAL_QUESTIONS) {
            setLoading(true);
            fetchDynamicQuestion().then((dynamicQuestion)=>{
                setQuestions((prev)=>[
                        ...prev,
                        dynamicQuestion
                    ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__82232e._.js.map