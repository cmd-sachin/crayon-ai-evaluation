(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_quizPage_page_b88478.js", {
...
(()=>{
    const e = new Error("Cannot find module '../app/stores/quizStore'");
...
(()=>{
    const e = new Error("Cannot find module '../app/stores/quizHistory'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
function QuizPage() {
    ...
    // Quiz store state.
    const { quizData, addQuizData, currentQuestionIndex, setCurrentQuestionIndex, timer, setTimer, clearStore } = useQuizStore();
...
//# sourceMappingURL=src_app_quizPage_page_b88478.js.map